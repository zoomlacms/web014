...
function AD_Content(o) {
  ...
  return str;
}var ZoneAD_16=new BannerZoneAD("ZoneAD_16");var objAD = new ObjectAD();
objAD.ADID= 27;objAD.ADType= 1;objAD.ADName= "新东方口语";objAD.ImgUrl= "/UploadFiles//AD/20127/201207051020019707.jpg";objAD.ImgWidth       = 0;objAD.ImgHeight      = 0;objAD.FlashWmode     = 0;objAD.ADIntro ="";objAD.LinkUrl        = "/Page/Default.aspx?pageid=79";objAD.LinkTarget     = 1;objAD.LinkAlt        = "新东方口语";objAD.Priority       = 1;objAD.CountView      = false;objAD.CountClick     = false;objAD.OverdueDate    = "2051/08/04";objAD.InstallDir     = "/";objAD.ADDIR= "/AD";ZoneAD_16.AddAD(objAD);ZoneAD_16.ZoneID=16;ZoneAD_16.ZoneWidth=235;ZoneAD_16.ZoneHeight=60;ZoneAD_16.ShowType=3;ZoneAD_16.Show();