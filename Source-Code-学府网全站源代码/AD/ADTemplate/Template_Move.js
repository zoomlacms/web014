...
function MoveZoneAD_Show() {
  ...
  if(this.ShowCloseAD){
      document.write("<div style='position: absolute;right: 0px;bottom: 0px;'><span style='cursor: pointer;' onclick='AD_CloseDL(\"" + this.DivName + "\");' style='font-size:12px;color:" + this.CloseFontColor + ";text-decoration:none;'>关闭</span></div>");
  }
  document.write("</div>");
