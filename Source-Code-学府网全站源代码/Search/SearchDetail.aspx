<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.SearchDetail, App_Web_ughlivwx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="us_seta">   
    ...
    <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="border">            
        ...
        <tr class="tdbg">
            ...
            <td style="width:80%;line-height:30px">
       		    从<asp:TextBox ID="BeginDate" runat="server" Height="13px" Width="120px" onclick="setday(this);"></asp:TextBox>
       		    到<asp:TextBox ID="EndDate" runat="server" Height="13px" Width="120px" onclick="setday(this);"></asp:TextBox>
            </td>
        </tr>
