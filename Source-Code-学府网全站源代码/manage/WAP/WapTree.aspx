<%@ page language="C#" autoeventwireup="true" inherits="manage_WAP_WapTree, App_Web_a1d2qkeh" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<html>
<head id="Head1" runat="server">
<title><%=lang.Get("m_WapTree_nav")%></title>
        ...
        <ul>
            <li id="Guide_top">
                <div id="Guide_toptext">
                    <%=lang.Get("m_WapTree_content")%></div>
            </li>
            <li id="Guide_main">
