<%@ page language="C#" autoeventwireup="true" inherits="manage_WAP_Other_Part_timeInfo, App_Web_fa4nov4w" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>兼职信息管理</title>
...
<div class="r_navigation">后台管理 &gt;&gt; Wap管理 &gt;&gt; <span><a href="Part-timeInfo.aspx">兼职信息管理</a><a href="Part-timeEdit.aspx?menu=add">[添加兼职信息]</a></div>
<div class="divbox" id="nocontent" runat="server" style="display: none">暂无兼职信息信息</div>
    <div>
        <asp:GridView ID="gvClass" runat="server" AutoGenerateColumns="False" class="border"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="标题" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <asp:Label ID="hlName" runat="server" Text='<%#Eval("name") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="内容" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                    <asp:Label ID="lblContent" runat="server" Text='<%# GetContent(Eval("content","{0}")) %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                </asp:TemplateField>
