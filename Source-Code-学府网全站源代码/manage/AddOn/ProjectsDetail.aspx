<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_ProjectsDetail_, App_Web_tbdzstjd" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div id="Tabs2" style="display: none">
        ...
        <table id="Comments" width="100%" border="0" cellpadding="2" cellspacing="1" class="border"
            style="margin: 0 auto; display: none;" runat="server">
            <tbody id="Tabs4">
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
