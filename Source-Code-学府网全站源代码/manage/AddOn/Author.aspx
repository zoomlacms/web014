<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_Author, App_Web_3z3bw0fh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
loadcalendar();
    ...
    <form id="form1" runat="server">
       <div class="r_navigation">
		...
		<span>后台管理</span>&gt;&gt;<span>其他管理</span> &gt;&gt;<span><a href="AuthorManage.aspx">作者管理</a></span> &gt;&gt;<span>
                                    添加作者</span>	</div> 
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
            ...
            <td rowspan="8" colspan="2">
                <table width="100%" border="0" cellpadding="2" cellspacing="1">
                    ...
                    <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        <td align="left"><asp:TextBox ID="txtpic" runat="server" ></asp:TextBox>*<asp:Label
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="TxtUserName" runat="server" class="l_input"></asp:TextBox></td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
                <strong>性别：</strong></td>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
            <td class="tdbgleft">
                <strong>生日：</strong></td>
            <td>
             <input name="member.birth" class="l_input" id="tbUBday" runat="server" type="text" value="1982-1-1" size="14" readonly="readonly" onclick="showcalendar(event, this);" onfocus="showcalendar(event, this);if(this.value=='0000-00-00')this.value=''" />(单击文本框,选择年月)  
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
                <strong>单位：</strong></td>
            <td>
                <asp:TextBox ID="TxtCompany" runat="server" MaxLength="20" class="l_input" /></td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
                <strong>部门：</strong></td>
            <td>
                <asp:TextBox ID="TxtDepartment" runat="server" MaxLength="20"  class="l_input"/></td>
            <td class="tdbgleft">
                <strong>主页：</strong></td>
            <td>
