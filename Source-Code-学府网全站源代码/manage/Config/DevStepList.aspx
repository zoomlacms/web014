<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_DevStepList, App_Web_3l1u0nin" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div>
    <asp:Literal runat="server" ID="ShowDiv" ></asp:Literal>
    </div>
