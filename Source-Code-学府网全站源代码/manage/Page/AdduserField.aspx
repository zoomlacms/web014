<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_AdduserField, App_Web_32dystoa" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="border" cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox ID="Alias" runat="server"  class="l_input" MaxLength="20"></asp:TextBox><font
                    color="#ff0066">*</font><span class="tips" style="color: #808000"> 如：文章标题</span></td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
                字段名称：
            ...
            <td>
                <asp:TextBox ID="Name" MaxLength="50" class="l_input" runat="server"></asp:TextBox><font
                    color="#ff0066">*</font><span class="tips" style="color: #808000">字段名由字母、数字、下划线组成</span>
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
