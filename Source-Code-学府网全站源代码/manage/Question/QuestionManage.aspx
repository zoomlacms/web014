<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_QuestionManage, App_Web_5h2ruwhk" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>系统试题管理</title>
...
<div class="r_navigation"><%if(GetOpenHelp.IsopenHelp()=="1")
  ...
  <%} %>后台管理 &gt;&gt; 扩展功能 &gt;&gt; <a href="QuestionManage.aspx">系统试题管理</a> <a href="AddQuestion.aspx?Operation=Add">[添加试题]</a></div>
