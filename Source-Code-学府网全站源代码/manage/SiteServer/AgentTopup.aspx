<%@ page language="C#" autoeventwireup="true" inherits="manage_SiteServer_AgentTopup, App_Web_jygtl5ei" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      <tr align="center">
        ...
        <td width="20%" class="title">代理商名</td>
        <td width="20%" class="title">充值金额</td>
        <td width="20%" class="title">充值时间</td>
