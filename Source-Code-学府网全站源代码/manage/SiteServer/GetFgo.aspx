<%@ page language="C#" autoeventwireup="true" inherits="manage_SiteServer_GetFgo, App_Web_jygtl5ei" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      <tr align="center">
        ...
        <td width="35%" class="title">文章标题</td>
        <td width="10%" class="title">类型</td>
        <td width="15%" class="title">接收时间</td>
         <td width="5%" class="title">是否处理</td>
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td height="22" align="left"><%# getTit(Eval("Xcontent"))%></a></td>
    ...
    <div>
        <asp:Button ID="Button3" runat="server" 
                        Text="同步数据" onclick="Button3_Click1" class="C_input"  OnClientClick="if(!IsSelectedId()){alert('请选择提交项');return false;}else{return confirm('你确定要提交选中内容吗？')}" /></div>
    </form>
</body>
</html>
