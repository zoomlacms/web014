<%@ page language="C#" autoeventwireup="true" inherits="manage_SiteServer_PayOnline, App_Web_jygtl5ei" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      <tr align="center">
        ...
        <td width="25%" class="title">付费账号</td>
        <td width="25%" class="title">付费金额</td>
        <td width="30%" class="title">付费时间</td>
