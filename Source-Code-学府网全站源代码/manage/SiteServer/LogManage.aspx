<%@ page language="C#" autoeventwireup="true" inherits="manage_SiteServer_LogManage, App_Web_jygtl5ei" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>  &gt;&gt; 站群管理  &gt;&gt; 日志<span>管理</span> </div>
    <div class="clearbox">
    </div>
    <div>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      <tr align="center">
        ...
        <td width="20%" class="title">日志主题</td>
        <td width="20%" class="title">日志时间</td>
        <td width="20%" class="title">日志用户</td>
