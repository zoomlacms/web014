<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Template.ZoneTemplateEdit, App_Web_cygfxagp" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
        ...
        <div>
            <table width="99%" cellpadding="2" border="0" cellspacing="1" class="border" align="center">
                ...
                <tr class="tdbg">
                    ...
                    <tr>
                        <td style="width: 262px; vertical-align: top;" id="frmTitle">
                        <div id="Tab1_header">
                        ...
                        <td height="435x" align="left" valign="top">
