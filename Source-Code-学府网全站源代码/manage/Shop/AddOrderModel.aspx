<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddOrderModel, App_Web_cbl2ckqe" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加订单模型</title>
 ...
 <form id="form1" runat="server">
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
        <tr class="tdbg">
            ...
            <td>
                <asp:TextBox class="l_input" ID="Alias" runat="server" MaxLength="20"></asp:TextBox><font color="#ff0066">*</font><span class="tips"> 如：标题</span>
