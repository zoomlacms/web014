<%@ page language="C#" autoeventwireup="true" enableviewstatemac="false" inherits="ZoomLa.WebSite.Manage.Template.TemplateManage, App_Web_4ohnmn4w" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<link type="text/css" rel="stylesheet" href="/js/lightbox2.02/css/lightbox.css" media="screen" />
<script type="text/javascript" src="../../js/lightbox2.02/js/prototype.js"></script>
<script type="text/javascript" src="../../js/lightbox2.02/js/scriptaculous.js?load=effects"></script>
<script type="text/javascript" src="../../js/lightbox2.02/js/lightbox.js"></script>
...
<div class="r_navigation">
 <%if(GetOpenHelp.IsopenHelp()=="1")
  ...
  <%} %> 后台管理&gt;&gt;系统设置 &gt;&gt;<a href="TemplateSet.aspx">方案设置</a></div>
<table width="100%">
    <tr>
