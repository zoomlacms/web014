<%@ page language="C#" autoeventwireup="true" inherits="manage_Guest_WdCheck, App_Web_wxbncm4g" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE >
<html>
...
<table border="0" cellpadding="0" cellspacing="0">
      <tr align="center">
        <td id="TabTitle0" class="titlemouseover" onclick="ShowTabss(0)"><a href="?type=0&id=0">所有问题</a></td>
	...
	<Columns>
        ...
        <asp:TemplateField HeaderText="" HeaderStyle-Width="0%" Visible="false">
          ...
          <asp:TextBox ID="txtName" class="l_input" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Tittle")%>'>'></asp:TextBox>
            ...
            <asp:TemplateField HeaderText="问题内容" HeaderStyle-Width="8%" >
                <ItemTemplate>
                    <%#Eval("Qcontent")%>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>                   
               <a href="Asklist.aspx?ID=<%#Eval("ID")%>">相关信息与回复管理</a>| <a href="/Guest/SearchDetails.aspx?soure=manager&ID=<%#Eval("ID") %>"  target="_blank">预览</a>
