 <%@ page language="C#" autoeventwireup="true" inherits="SlPage, App_Web_vwwbvku3" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html >
...
<body style=" background:<%= getUrl()%>">
    <form id="form1" runat="server" style="height:100%">
   <div id="maga_tit"><span id="maga_mus"><iframe id="I1"  scrolling="no"  style="height: 40px;border:0px width: 131px;"src="../User/Magazine/BgMusice.aspx?id=<%=Request["id"] %> " frameborder="0" ></iframe> </span><h1>  <%=GetTitle() %></h1>
   </div>
