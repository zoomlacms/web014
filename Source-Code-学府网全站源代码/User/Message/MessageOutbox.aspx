<%@ page language="C#" autoeventwireup="true" inherits="User_Message_MessageOutbox, App_Web_wtzgd1id" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>发件箱</title>
...
<div class="us_topinfo">
  您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a> &gt;&gt; <a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a> &gt;&gt; </span><span><a title="短消息管理" href="/User/MessageOutbox.aspx">发件箱</a>
</div>
...
<div style="margin-top:10px;">
	<div class="us_infoa">
	  <div class="us_seta" style="margin-top:5px;">
			<h1 align="center">发件箱</h1>
			<div class="us_pynews">
				<span lang="zh-cn">&nbsp;&nbsp; </span>
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    OnRowEditing="GridView1_RowEditing" Width="100%" AllowPaging="True" 
                    DataKeyNames="MsgID" OnRowCommand="Row_Command" 
...
<asp:Button ID="mobiletext" runat="server" Font-Size="9pt" Text="手机短信" class="C_input" 
                    onclick="mobiletext_Click" /> 
