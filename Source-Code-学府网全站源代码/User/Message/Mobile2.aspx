...
#phone_cont{ color:#39F; width:150px;}
...
var a=parent.document.getElementById('names').innerHTML;
var b=parent.document.getElementById('address').innerHTML;
var c=parent.document.getElementById('school_t').innerHTML;
document.getElementById("EditorContent").value=a+c+b;
document.getElementById("phone_cont").innerHTML='<p>您要下载的商家信息是：</p>'+a+'<br/>地址:'+b+';<br/>电话:'+c;
  }
