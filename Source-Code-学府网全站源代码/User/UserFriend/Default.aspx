<%@ page language="C#" autoeventwireup="true" inherits="User_UserFriend_Default, App_Web_ysuqqlt3" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt;<a title="会员中心" href="/User/Default.aspx" target="_blank">会员中心</a>&gt;&gt;<a title="我的好友" href="/User/UserFriend/Default.aspx">我的好友</a>&gt;&gt;我的好友
</div>
	...
	<div class="us_topinfo" style="margin-top: 10px;">
		...
		<li style="width: 70%; height: 30px; text-align: right; margin-top: 10px;">好友搜索：
										<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
			<asp:Button ID="Button1" runat="server" Text="搜  索" OnClick="Button1_Click" /></li>
		<li style="width: 70%;">
