<%@ page language="C#" autoeventwireup="true" inherits="User_Info_userCarInfo, App_Web_l5ehgeoe" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    <div style=" text-align:center">
		  <div class="us_seta" style="margin-top:10px; Width:800px">
			  <h1 style="text-align:center"><asp:Label ID="Label1" runat="server" Text=""></asp:Label></h1>
