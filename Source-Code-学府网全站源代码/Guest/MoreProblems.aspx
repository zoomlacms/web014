<%@ page language="C#" autoeventwireup="true" inherits="Guest_MoreProblems, App_Web_zrlcdh4i" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="h_b_m">
            <div class="question_count">
                ...
                <asp:TextBox runat="server" ID="txtAsk" onmouseover="this.focus()" 
                        ...
                        onclick="btnSearch_Click" Height="29px" Width="78px" /> 
                    <asp:Button runat="server" ID="btnAsk"  class="but" Text=" " 
                        onclick="btnAsk_Click" Height="29px" Width="78px" />  
                    ...
                    <asp:Button runat="server" ID="btnAnswer" class="answer" Text=""   
                        onclick="btnAnswer_Click" Height="29px" Width="78px" />
  ...
  <ul>
            <asp:Repeater runat="server" ID="repSearch">
                  <ItemTemplate>
                            ...
                            <li>&nbsp;<td> <a target="_self" href="SearchDetails.aspx?ID=<%#Eval("ID")%>"><%#Eval("Qcontent")%></a></td><span class="lei">[<td><a target="_self" href="AskList.aspx?QueType=<%#Eval("QueType")%>&strwhere="><%#gettype(Eval("QueType","{0}"))%></a></td>]</span><span class="qanswers"><%#getcount(Eval("ID", "{0}"))%>回答</span></li><br />
