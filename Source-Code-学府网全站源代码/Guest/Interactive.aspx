<%@ page language="C#" autoeventwireup="true" inherits="Guest_Interactive, App_Web_zrlcdh4i" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<a href="Ask.aspx">问答</a></span>
    ...
    <div id="main" class="rg_inout">
        <h1>
           <span style="float:left; width: 397px;"> 您的位置：<a href="Ask.aspx">网站首页</a>>>&nbsp;<a href="Default.aspx">留言中心</a>>><a href="Ask.aspx">问答</a>>><a href="MyAskList.aspx?QueType=">我的提问</a>>><a href="Interactive.aspx?ID=<%=Request["ID"]%>">我的提问互动详情</a>&nbsp;&nbsp;</span>
...
<a href="Ask.aspx">问答</a></span>--%>
 ...
 <div style="background: #8EC1EE; width: 965px;">
  <h1><span style="color: #fff; height: 30px; padding: 0 5px; float:right">提问者：<asp:Label style="color: #fff;" ID="username" runat="server"></asp:Label></span>
               <span style="color: #fff; height: 30px; padding: 0 5px; float:right">提问日期：<asp:Label style="color: #fff;" ID="addtime" runat="server"></asp:Label></span></h1>
      ...
      <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" OnItemCommand="Repeater1_ItemCommand">
        <ItemTemplate>
          ...
          <div class="g_show_txt"><%# Eval("Content")%> <div style=" float:right;color:red" id="recomand"><%#getstatus(Eval("Status","{0}"))%></div>
