<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.NodeManage, App_Web_lmrcgmxm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr class="tdbg" id="list<%#Getprname(Eval("NodeID"))%>" name="list<%#Getprid(Eval("NodeID"))%>"
                        align="center" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        <td height="22" align="center">
                            <input name="Item" type="checkbox" value="<%# Eval("NodeID")%>" <%#returnstrat(Eval("NodeID"))%>/>
                        </td>
                        ...
                        <td width="40%" align="left">
                            ...
                            (<%#GetNum(DataBinder.Eval(Container, "DataItem.NodeID", "{0}")) %>)
                        </td>
                        <td width="12%" height="20">
                            <strong>
            ...
            <tr>
                <td colspan="5" style="height: 30px" align="left">
                    &nbsp;<asp:Button ID="Button3" runat="server" OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');"
                        CssClass="button" Text="批量删除" OnClick="Button3_Click" />
                </td>
            </tr>
        </table>
    </div>
