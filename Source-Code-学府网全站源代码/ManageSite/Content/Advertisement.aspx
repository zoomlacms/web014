<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.AddOn.Advertisement, App_Web_lmrcgmxm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
        <div class="column">
        <div class="columntitle">当前位置：功能导航 >>添加广告</div>
	    
    <table border="0" cellpadding="2" cellspacing="1"  width="100%">
      <tr valign="middle" >
        <td class="spacingtitle" colspan="2" style="height: 26px; text-align:center; background-color:#F0F6FC;"><strong><asp:Label ID="Label1" runat="server" Text="添加广告内容"></asp:Label></strong></td></tr>
                       ...
                       <table id="ADContent1" border="0" cellpadding="2" cellspacing="1" width="100%" runat="server">
                            ...
                            <tr class="tdbg">
                                ...
                                <td style="width:352px; height: 55px; color: red;">
                                    ...
                                    <iframe id="Upload_Pic" src="../Common/Upload.aspx?CID=pic&ftype=4" marginheight="0" marginwidth="0" frameborder="0" width="100%" height="30" scrolling="no"></iframe>
                                    </td>
                            </tr>
                            <tr class="tdbg">
                                <td align="right" style="width: 20%;" class="tdbgleft">
    ...
    <table border="0" cellpadding="2" cellspacing="1" width="100%">
        <tr>
            <td valign="middle" colspan="2" style="width: 100%; height: 25px" align="center">
                <asp:Button ID="EBtnSubmit" CssClass="button"  runat="server" Text="保存" OnClientClick="javascript:return CheckForm();" OnClick="EBtnSubmit_Click" />          
                &nbsp;&nbsp<input id="Cancel" class="button"  name="Cancel" onclick="GoBack();" style="cursor: hand"
