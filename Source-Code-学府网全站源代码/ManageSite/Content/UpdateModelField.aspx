<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.UpdateModelField, App_Web_lmrcgmxm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="column">
        <div class="columntitle">
           当前位置：功能导航 >> 修改[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段 &nbsp; &nbsp;
    ...
    <table  cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
        <tr class="tdbg">
            ...
            <td align="left">
                <asp:TextBox ID="Alias" runat="server" MaxLength="20"></asp:TextBox><font color="#ff0066">*</font><span class="tips"> 如：文章标题</span>
            </td>
        </tr>
        <tr class="tdbg">
            <td align="right">
            ...
            <td align="left">
                <asp:TextBox ID="Name" MaxLength="50" runat="server"></asp:TextBox><font color="#ff0066">*</font><span class="tips">字段名由字母、数字、下划线组成，不接受空格</span>
            </td>
        </tr>
        <tr class="tdbg">
            <td align="right">
        ...
        <tbody id="DivTextType" runat="server">
            ...
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="TextType_DefaultValue" runat="server" Columns="10"></asp:TextBox> 【<a href="javascript:void(0);" onclick="checkDef();">当前用户名</a>】【<a href="javascript:void(0);" onclick="checkDef('匿名');">匿名</a>】【<a href="javascript:void(0);" onclick="checkDef('本站作者');">本站作者</a>】
                </td>
            </tr>
        </tbody>
        <!--  多行文本(不支持Html)    -->
        ...
        <tbody id="DivListBoxType" style="display: none" runat="server">
            <tr class="tdbg">
                ...
                <td align="left">
                    <input id="Button4" type="button" value="从数据字典中选择选项" class="btn" onclick="SelectDictionary('ListBoxType_Content')" /><input id="Button2" type="button" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                <asp:Button ID="Button1" runat="server" Text=" 修改字段 "  CssClass="button"  OnClientClick="return isok()" OnClick="Button1_Click" />
                &nbsp;&nbsp;
                <asp:Button ID="BtnBack" runat="server" Text="返回字段列表" OnClick="BtnBack_Click"  CssClass="button" UseSubmitBehavior="False" CausesValidation="False" />
