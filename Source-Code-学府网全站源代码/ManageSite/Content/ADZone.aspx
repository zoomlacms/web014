<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.ADZone, App_Web_lmrcgmxm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <div class="column">
        <div class="columntitle">当前位置：功能导航 >>添加版位</div>         
        <table border="0" cellpadding="2" cellspacing="1" class="border" width="100%">
            <tr>
                <td class="spacingtitle" colspan="2" style="height: 26px" style="background-color:#F0F6F4">
        ...
        <asp:Button ID="EBtnAdZone" CssClass="button"  runat="server" OnClick="EBtnAdZone_Click" Text="保存" />
        &nbsp;&nbsp; &nbsp;
        <input id="Cancel" class="button" name="Cancel" onclick="GoBack();" style="cursor: hand"
