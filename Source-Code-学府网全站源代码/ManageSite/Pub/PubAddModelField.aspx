<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_PubAddModelField, App_Web_bufxqd3e" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
 ...
 添加[<asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>模型]字段
    </div>
    ...
    <table cellspacing="1" cellpadding="0" width="99%" border="0" align="center">
        ...
        <tbody id="DivOptionType" style="display: none">
            <tr class="tdbg">
                ...
                <td align="left">
                    <input id="Button3" type="button" value="从数据字典中选择选项" class="btn" onclick="SelectDictionary('RadioType_Content')" /><input id="Button5" type="button" value="添加数据字段" onclick='SubPage("RadioType_Content")' /><br />
        ...
        <tbody id="DivListBoxType" style="display: none">
            <tr class="tdbg">
                ...
                <td align="left">
                    <input id="Button4" type="button" value="从数据字典中选择选项" class="btn" onclick="SelectDictionary('ListBoxType_Content')" /><input id="Button6" type="button" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
        ...
        <tbody id="DivOperatingType" style="display: none">
            ...
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="OperatingType_TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox><span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg">
                <td class="tdbgleft">
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                ...
                &nbsp;&nbsp;
                <input id="Button2" type="button" value=" 返回字段列表 " class="button" onclick="javascript:window.location.href='PubModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>&nid=<%=Request.QueryString["nid"] %>'" />
