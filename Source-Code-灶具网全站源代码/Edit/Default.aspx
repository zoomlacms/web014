<%@ page language="C#" autoeventwireup="true" enableviewstatemac="false" inherits="Edit_EditContent, App_Web_0grsoeat" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>写作助理</title>
...
<div id="w_content" style="width: 100%; padding: 1px;">
    <div id="w_conL" style="width: 48%">
        ...
        <iframe id="contents" src="Source.aspx" name="contents" style="width: 99%; height: 98%;
...
<span><a href="#">剪切 </a><a href="#"> 复制</a><a href="#">粘贴 </a></span><img src="../Template/style/images/w_word1.gif" alt="" /><img src="../Template/style/images/w_word2.gif" alt=""/>--%>
        ...
        <div id="WCON_r_c01" style="height: 95%; margin-right: 10px; background: none;">
            ...
            %>
            <iframe id="Edit" name="Edit" src="Edit.aspx?ID=<%=id%>&DocType=<%=Request.QueryString["DocType"] %>&DocTitle=<%=Request.QueryString["DocTitle"] %>&uptp=<%=Request.QueryString["uptp"] %>&date=<%=DateTime.Now.ToString() %>"
                style="width: 100%; height: 97%; overflow: auto"></iframe>
        </div>
    </div>
</div>
</form>
