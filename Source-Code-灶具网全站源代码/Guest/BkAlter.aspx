<%@ page language="C#" autoeventwireup="true" inherits="manage_GuestBook_BkAlter, App_Web_zrlcdh4i" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head>
    ...
    <li><a href="baiclassification.aspx?tittle=体育">体育</a></li>
        ...
        <div class="cleardiv" style="padding: 5px;">
            ...
            <h1>
                您的位置：<a href="/">网站首页</a>>>&nbsp;<a href="Default.aspx">留言中心</a>>><a href="Baike.aspx">逐浪百科</a>>><a
                    href="#GuestBorder">修改词条</a></h1>
        </div>
        <div><h2><p>
                <asp:Label runat="server" ID="lblTittle" Font-Bold="True" Font-Size="Larger" ForeColor="#3171AF">百科</asp:Label></p></h2></div>
        ...
        <div>
            <asp:TextBox runat="server" ID="txtExtend" CssClass="x_input" TextMode="MultiLine"
                Width="773" Height="80"></asp:TextBox></div>
                 <span style="color: #3171af; height: 30px; padding: 5px 5px;">修改原因</span>
