<%@ page language="C#" autoeventwireup="true" inherits="Guestbook_MyAnswer, App_Web_rffrteow" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="h_b_m">
                ...
                <div class="h_b_input">
                    ...
                    <asp:Button runat="server" ID="Button1" class="sub" Text=" " OnClick="btnSearch_Click"
                        />
                    <asp:Button runat="server" ID="Button2" class="but" Text=" " OnClick="btnAsk_Click"
                        />
                    <%-- <div style="display:none"><asp:Button  runat="server" ID="btnMyAsk" Text="我的提问" OnClick="btnMyAsk_Click"/></div>--%>
                    <asp:Button runat="server" ID="Button3" class="answer" Text="" OnClick="btnAnswer_Click"
                        />
                </div>
                <div class="sybz">
    ...
    <div id="main" class="rg_inout">
        <h1>
            <span style="float: left; width: 397px;">您的位置：<a href="Ask.aspx">网站首页</a>>>&nbsp;<a href="Default.aspx">留言中心</a>>><a
         <a href="AskList.aspx?strWhere=&QueType=">问题列表</a>>>&nbsp;<a href="MyAnswer.aspx?ID=<%=Request["ID"]%>">问题详情</a>&nbsp;</span>
         <%--<span style="float: right;
                    font-size: 20px"> <a href="Baike.aspx" >百科</a>  <a href="Default.aspx">留言</a> <a href="Ask.aspx"> 问答</a></span>--%>
        </h1>
        ...
        <div style="border-top: 2px solid #3171af; padding: 25px 0 10px 16px;">
            <div style="background: #8EC1EE; width: 964px;">
                <h1>
            ...
            <div id="g_show">
                <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                    <ItemTemplate>
                        <h1>
                            <span>[回答者：<%#Eval("UserName")%>]<span style="float: right">回答日期：<%# Eval("AddTime")%></span></h1>
                        <div class="g_show_txt">
                            <%# Eval("Content")%><div style=" float:right;color:red" id="recomand"><%#getstatus(Eval("Status","{0}"))%></div>
                ...
                <div id="styreply" style="display:none; position:absolute;">
                               <%-- <div style="background: #8EC1EE; width: 500px;">
                                    <span style="color: #fff; height: 31px; padding: 0 5px;">回复追问：</span></div>--%>
                                <div >
                                <asp:HiddenField ID="Rid" runat="server" Value="" />
                                    <asp:TextBox runat="server" ID="txtreply" CssClass="x_input" TextMode="MultiLine"
                                        Width="965" Height="140"> </asp:TextBox><br />
                                </div>
                                <asp:Button runat="server" ID="btnreply" Text="提交回复" CssClass="C_input" OnClick="btnreply_Click" />
                                 </div>
                       
                  <div style="background: #8EC1EE; width: 965px;">
            <span style="color: #fff; height: 30px; padding: 0 5px;">您的回答</span></div>
        <div>
            <asp:TextBox runat="server" ID="txtContent" CssClass="x_input" TextMode="MultiLine"
                Width="965px" Height="80px"></asp:TextBox>
                </div>
             
                 <span><asp:Button runat="server" ID="btnSubmit" Text="提交" CssClass="C_input" OnClick="btnSubmit_Click" /></span></div>
