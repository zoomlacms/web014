<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Guest_AnswerList, App_Web_zrlcdh4i" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
...
<h1>   您的位置：<a href="Ask.aspx">网站首页</a>>>&nbsp;<a href="Default.aspx">留言中心</a>>><a href="AskList.aspx?strWhere=&QueType=">我要回答</a> <td><%-- <span style=" float:right"><asp:Label ID="lblUserName" runat="server" Text="" />| <a href="<%=ResolveUrl("~/User/logout.aspx") %>" style=" color:Red"><%=lang.Get("u_exit")%></a> ]</span>--%> </h1>  
    ...
    <asp:GridView ID="Gdv" DataKeyNames="ID"  
      ...
      <asp:TemplateField HeaderText="内容">
        <ItemTemplate> <a href="MyAnswer.aspx?ID=<%# Eval("ID")%>"><%# Eval("Qcontent")%></a> </ItemTemplate>
        <ItemStyle  CssClass="tdbg"/>
        <HeaderStyle Width="35%" />
      </asp:TemplateField>
      <asp:TemplateField HeaderText="类别">
        <ItemTemplate> <a href="AskList.aspx?QueType=<%# Eval("QueType")%>&strWhere="><%#gettype(Eval("QueType","{0}"))%></a></ItemTemplate>
        <ItemStyle  CssClass="tdbg"  />
