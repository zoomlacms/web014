<%@ page language="C#" autoeventwireup="true" inherits="manage_Polymeric_ClassManage, App_Web_5u4xe23a" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
        <div class="r_navigation">
          后台管理&gt;&gt;用户管理&gt;&gt;分类管理 [<a href="AddClass.aspx">添加分类</a>]
    </div>
    <div class="clearbox">
    </div>
