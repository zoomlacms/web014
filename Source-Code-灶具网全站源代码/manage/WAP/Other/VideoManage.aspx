<%@ page language="C#" autoeventwireup="true" inherits="manage_WAP_Other_VideoManage, App_Web_fa4nov4w" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>小视频管理</title>
...
<div class="r_navigation">后台管理 &gt;&gt; Wap管理 &gt;&gt; <span><a href="VideoManage.aspx">视频管理</a><a href="AddVideo.aspx?menu=add">[添加视频]</a></div>
<div class="divbox" id="nocontent" runat="server" style="display: none">暂无视频信息</div>
<div>
        <asp:GridView ID="gvClass" runat="server" AutoGenerateColumns="False" class="border"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="视频名称" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
