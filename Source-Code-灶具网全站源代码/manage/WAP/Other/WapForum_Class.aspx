<%@ page language="C#" autoeventwireup="true" inherits="manage_WAP_Other_WapForum_Class, App_Web_fa4nov4w" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>板块管理</title>
...
<div class="r_navigation">后台管理 &gt;&gt; Wap管理 &gt;&gt; <a href="WapForum_Class.aspx">论坛板块信息</a><a href="WapForum_Class_Edit.aspx?menu=add">[添加论坛板块]</a></div>
<div class="divbox" id="nocontent" runat="server" style="display: none">暂无板块信息</div>
    <div>
        <asp:GridView ID="gvClass" runat="server" AutoGenerateColumns="False" class="border"
            ...
            OnRowDataBound="gvClass_RowDataBound" HeaderStyle-Height="28px" 
            onrowcommand="gvClass_RowCommand">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="板块名称" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <asp:Label ID="hlName" runat="server" Text='<%#Eval("name") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="所属板块" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
