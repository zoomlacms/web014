<%@ page language="C#" autoeventwireup="true" inherits="manage_3Dmanage_UserList, App_Web_hhcircfd" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
			...
			<tr class="title">
				...
				<td align="right">
					<asp:TextBox ID="TxtKeyWord" class="l_input" runat="server"></asp:TextBox>&nbsp;&nbsp;<asp:Button
						ID="BtnSearch" runat="server" Text="查找"   CssClass="C_input"/></td>
			</tr>
			<tr>
				<td valign="top" colspan="2">
					...
					<asp:Repeater ID="RepUser" runat="server" OnItemDataBound="RepUser_ItemDataBound">
						...
						<ItemTemplate>
							<td align="center" class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
...
////                    }
////                    else {
////                        opener.document.getElementById('<%= m_UserInput %>').value = singleUserName[i];
