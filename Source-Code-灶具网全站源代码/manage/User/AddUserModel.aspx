<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddUserModel, App_Web_du31ah4f" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" style="margin: auto;">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td>
                <asp:TextBox CssClass="l_input" ID="Alias" runat="server" MaxLength="20"></asp:TextBox>
        ...
        <tbody id="DivPicType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox CssClass="l_input" ID="TxtPicExt" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody id="DivMultiPicType" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox CssClass="l_input" ID="TextImageType" runat="server" Columns="30"></asp:TextBox>
                    <span style="color: red">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span>
                </td>
            </tr>
        </tbody>
        ...
        <tbody id="DivSmallFileType" style="display: none" runat="server">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox CssClass="l_input" ID="TxtUploadFileTypes" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody id="DivFileType" style="display: none" runat="server">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox CssClass="l_input" ID="TxtUploadFileType" runat="server" Columns="30"></asp:TextBox>
                    <span style="color: red">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span>
                </td>
            </tr>
        </tbody>
