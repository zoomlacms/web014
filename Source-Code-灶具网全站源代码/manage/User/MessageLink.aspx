<%@ page language="C#" autoeventwireup="true" inherits="manage_User_MessageLink, App_Web_acccxktx" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
        ...
        <div id="Guide_box">
          ...
          <div class="guide">
            <ul>
              ...
              <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../User/MailList.aspx" target="main_right"><%=lang.Get("m_MessageLink_mailingList")%></a></li>
