<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UrlReWr, App_Web_acccxktx" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
 <%if(GetOpenHelp.IsopenHelp()=="1")
    { %>
      <div id="help"> <a onclick="help_show('18')" title="帮助"></a></div>
  <%} %> 后台管理 &gt;&gt; 系统配置 &gt;&gt; <a href="UrlReWr.aspx">栏目变子站管理</a> &nbsp;&nbsp;&nbsp;<a href="addUrlReWr.aspx">[ 添加栏目变子站  ]</a>
</div>
<div style="text-align:center"></div>
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td height="22" align="left"><%# Eval("Sendto")%></td>
