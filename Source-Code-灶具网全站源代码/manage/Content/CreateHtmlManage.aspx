<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.CreateHtmlManage, App_Web_hffwpi2t" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div>
  ...
  <div class="r_navigation">
 &nbsp; &nbsp;
   选择节点内容生成： <asp:DropDownList ID="DropDownList2" runat="server" 
