<%@ page language="C#" autoeventwireup="true" inherits="manage_Boss_EditBoss, App_Web_tj4igoux" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
		...
		<tbody id="Tabs0">          
			...
			<tr class="tdbg">
			  ...
			  <tr class="tdbg">
				...
				<td>
					<asp:TextBox ID="CMoney" runat="server" Width="150px"></asp:TextBox>元
