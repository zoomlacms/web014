<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_OthersGuide, App_Web_3z3bw0fh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
                ...
                <div id="Guide_box">
                    ...
                    <div class="guide">
                        <ul>
                            ...
                            <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="AddSource.aspx" target="main_right"><%=lang.Get("m_OthersGuide_add")%></a></li>
                            ...
                            <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="Author.aspx" target="main_right"><%=lang.Get("m_OthersGuide_addauthor")%></a></li>
                            ...
                            <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="AddKeyWord.aspx" target="main_right"><%=lang.Get("m_OthersGuide_addkey")%></a></li>
