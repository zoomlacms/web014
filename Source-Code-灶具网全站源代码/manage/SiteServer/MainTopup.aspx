<%@ page language="C#" autoeventwireup="true" inherits="manage_SiteServer_MainTopup, App_Web_jygtl5ei" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      <tr align="center">
        ...
        <td width="25%" class="title">充值时间</td>
        <td width="25%" class="title">今日充值金额</td>
