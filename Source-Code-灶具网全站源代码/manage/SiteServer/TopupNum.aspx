<%@ page language="C#" autoeventwireup="true" inherits="manage_SiteServer_TopupNum, App_Web_jygtl5ei" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      <tr align="center">
        ...
        <td width="25%" class="title">今日充入金额</td>
        <td width="30%" class="title">总充入金额</td>
    ...
    <div>
       ...
       <asp:Button ID="Button1" class="C_input" runat="server" Text="强制发送方案"    />                        
    </div>
</form>
</body>
</html>
