<%@ page language="C#" autoeventwireup="true" inherits="manage_SiteServer_AgentManage, App_Web_jygtl5ei" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        ...
        <span>后台管理</span>  &gt;&gt; 站群管理  &gt;&gt; <span>财务管理</span> 
        &gt;&gt; 代理商管理</div>
    <div class="clearbox">
    </div>
    <div>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      <tr align="center">
        ...
        <td width="20%" class="title">代理商号</td>
        <td width="20%" class="title">代理商</td>
        <td width="20%" class="title">代理商地区</td>
        <td width="20%" class="title">申请代理时间</td>
