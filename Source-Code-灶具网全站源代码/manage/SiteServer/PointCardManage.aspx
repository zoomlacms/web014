<%@ page language="C#" autoeventwireup="true" inherits="manage_SiteServer_PointCardManage, App_Web_jygtl5ei" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
      <tr align="center">
        ...
        <td width="25%" class="title">点卡号</td>
        <td width="25%" class="title">点卡点数</td>
        <td width="30%" class="title">有效期</td>
