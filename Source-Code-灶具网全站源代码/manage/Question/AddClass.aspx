<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_AddClass, App_Web_5h2ruwhk" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
        <tbody id="Tabs0">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txt_Setuptime" runat="server" class="l_input" Width="200px" onclick="calendar()"></asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
                ...
                <td class="bqright">
                    <asp:TextBox ID="txt_Endtime" runat="server" class="l_input" Width="200px" onclick="calendar()"></asp:TextBox>
                </td>
            </tr>
