<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_AddDevStep, App_Web_3l1u0nin" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<tr class="tdbg">
            <td align="left" style="height: 410px" width="165px" valign="top">
                <div id="Tab1_header">
    ...
    <div style="cursor:move;background-color:Gray;border-bottom-style:solid;border-bottom-color:White" onmousedown="creatdivlable('测试4')">测试4</div>
                                ...
                                <tbody id="Tabs1" runat="server" style="display: none">
                                    <tr align="center">
                                        <td>
                                            ...
                                            <a href="#" onclick="showadd(0)">添加执行sql语句</a>                                                                                         <asp:Label ID="LblSourceField" runat="server"></asp:Label></div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <td><div id="D_Showdivs" style="width:100%;height:410px;background-color:White" onmousemove=ismove=true onmouseout=ismove=false> <asp:Literal runat="server" ID="L_showdiv"></asp:Literal></div></td>
        </tr>
<tr class="tdbgbottom">
	<td colspan="2"> 
