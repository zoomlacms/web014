<%@ page language="C#" autoeventwireup="true" inherits="Store_ShopSearch, App_Web_tk3h02l1" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>商城搜索</title>
...
<script src="../Common/RiQi.js"></script>
<body>
    ...
    <div class="us_seta">
        ...
        <div class="us_seta">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr>
                <td>开始时间：<asp:TextBox ID="txtStartTime" runat="server"  OnFocus="setday(this)"></asp:TextBox></td>
                <td>结束时间：<asp:TextBox ID="txtEndTime" runat="server" OnFocus="setday(this)"></asp:TextBox></td>
                </tr>
                <tr>
