<%@ page language="C#" autoeventwireup="true" inherits="ManageSite_Template_CssManage, App_Web_tap0iily" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="column">
        <div class="columntitle">
            当前位置：功能导航 >>  
            <asp:Label ID="lblName" runat="server" Text="Label"></asp:Label> >> 显示管理 >> 风格管理>>当前目录：<asp:Label ID="lblDir" runat="server" Text="Label"></asp:Label>&nbsp;&nbsp;&nbsp;<asp:Literal
                ...
                <td colspan="5" align="left">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" >
                        ...
                        <td  style=" width:6%" align="right">
                            ...
                            <td align="left">
                                <asp:Button ID="btnTemplateUpLoad" CssClass="button" runat="server" Text="上传风格" OnClientClick="return confirm('即将上传风格文件，是否继续？');"
