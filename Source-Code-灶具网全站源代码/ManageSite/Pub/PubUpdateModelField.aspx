<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_PubUpdateModelField, App_Web_bufxqd3e" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		当前位置：功能导航 &gt;&gt;
		<span>后台管理</span> &gt;&gt; <span><a href="../Content/ContentManage.aspx">内容管理</a></span> &gt;&gt; <a href="pubModel.aspx">互动模型管理</a>
    &gt;&gt; <a href="PubModelField.aspx?ModelId=<%= MID %>">字段列表</a>
