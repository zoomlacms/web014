<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddModelField, App_Web_lmrcgmxm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
     <div class="column">
        <div class="columntitle">
           当前位置：功能导航 >> 为<a href="AddModelField.aspx"><asp:Literal ID="Literal1" runat="server"></asp:Literal>模型添加字段 </a>&nbsp; &nbsp;
                <asp:Label ID="Label1" runat="server" Text=""></asp:Label>&nbsp;</div>

    <table  cellspacing="1" cellpadding="0" width="99%" border="0" align="center">        
        <tr class="tdbg">
            <td align="right">
                <strong>字段别名：</strong>
            </td>
            <td align="left">
                <asp:TextBox ID="Alias" runat="server" MaxLength="20"></asp:TextBox><font color="#ff0066">*</font><span class="tips" style="color: #808000"> 如：文章标题</span>
            </td>
        </tr>
        <tr class="tdbg">
            <td align="right">
            ...
            <td align="left">
                <asp:TextBox ID="Name" MaxLength="50" runat="server"></asp:TextBox><font color="#ff0066">*</font><span class="tips" style="color: #808000">字段名由字母、数字、下划线组成，不接受空格</span>
            </td>
        </tr>
        <tr class="tdbg">
            <td align="right">
            ...
            <td align="left">
                <asp:TextBox ID="Tips" MaxLength="50" runat="server"></asp:TextBox><span class="tips" style="color: #808000">显示在字段别名下方作为重要提示的文字</span>
            </td>
        </tr>
        <tr class="tdbg">
            <td align="right">
            ...
            <td align="left">
                <asp:TextBox ID="Description" runat="server" Columns="40" Rows="6" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr class="tdbg">
            <td align="right">
        ...
        <tr class="tdbg" id="downserver" runat="server" visible="false">
            <td align="right">
                ...
                【<a href='../file/DownServerManage.aspx?ModelID=<%=Request.QueryString["ModelID"] %>'>管理下载服务器</a>】
            </td>
            <td align="left">
        ...
        <tbody id="DivTextType">
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox>
                    px</td>
            </tr>
            <tr class="tdbg">
                <td align="right">
            ...
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="TextType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
        ...
        <tbody id="DivMultipleTextType" style="display: none">
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="MultipleTextType_Width" runat="server" Columns="10" MaxLength="4">500</asp:TextBox>px
                </td>
            </tr>
            <tr class="tdbg">
                <td align="right">
                ...
                <td align="left">
                    <asp:TextBox ID="MultipleTextType_Height" runat="server" Columns="10" MaxLength="4">200</asp:TextBox>px
                </td>
            </tr>
        </tbody>
        <!--  多行文本(支持Html)    -->
        <tbody id="DivMultipleHtmlType" style="display: none">
            ...
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="MultipleHtmlType_Height" runat="server" Columns="10" MaxLength="4">400</asp:TextBox>px
                </td>
            </tr>
        </tbody>
        <!--  单选项    -->
        <tbody id="DivOptionType" style="display: none">
            <tr class="tdbg">
                ...
                <td align="left">
                    <input id="Button3" class="button" type="button" value="从数据字典中选择选项"  onclick="SelectDictionary('RadioType_Content')" /><input id="Button5" type="button" class="button" value="添加数据字段" onclick='SubPage("RadioType_Content")' /><br />
                    <asp:TextBox ID="RadioType_Content" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox>
        ...
        <tbody id="DivListBoxType" style="display: none">
            <tr class="tdbg">
                ...
                <td align="left">
                    <input id="Button4" type="button" class="button" value="从数据字典中选择选项"  onclick="SelectDictionary('ListBoxType_Content')" /><input id="Button6" type="button" class="button" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
                    <asp:TextBox ID="ListBoxType_Content" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox>
                    <span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg">
        ...
        <tbody id="DivPicType" style="display: none">
            ...
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="TxtSPicSize" runat="server" Columns="5">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg">
                <td align="right">
                ...
                <td align="left">
                    <asp:TextBox ID="TxtPicExt" runat="server" Columns="30"></asp:TextBox><span style="color: red">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span>
                </td>
            </tr>
        </tbody>
        <!--  多图片    -->
        <tbody id="DivMultiPicType" style="display: none">
            <tr class="tdbg">
                ...
                <td align="left">
                    ...
                    <asp:TextBox ID="TxtThumb" runat="server" Columns="20"></asp:TextBox><span style="color: Red; display: none;">保存缩略图地址字段名不能与主字段名重复！</span>
                </td>
            </tr>
            <tr class="tdbg">
                <td align="right">
            ...
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="TxtPicSize" runat="server" Columns="5">1024</asp:TextBox>KB <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr class="tdbg">
                <td align="right">
        ...
        <tbody id="DivOperatingType" style="display: none">
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="TxtOperatingOption" runat="server" TextMode="MultiLine" Columns="40" Rows="6"></asp:TextBox>
            ...
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="OperatingType_TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox>
                    px</td>
            </tr>
            <tr class="tdbg">
                <td align="right">
                ...
                <td align="left">
                    <asp:TextBox ID="OperatingType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span style="color: green">例：Win2000|XP|Win2003</span>
                </td>
            </tr>
        </tbody>
        <!--  超链接    -->
        <tbody id="DivSuperLinkType" style="display: none">
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="SuperLinkType_TitleSize" runat="server" Columns="10" MaxLength="4">50</asp:TextBox>
                    px</td>
            </tr>
            <tr class="tdbg">
                <td align="right">
                ...
                <td align="left">
                    <asp:TextBox ID="SuperLinkType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span style="color: green">例：http://127.0.0.1/</span>
                </td>
            </tr>
        </tbody>
        <!--  多级选项    -->
        ...
        <tbody id="DivNumType" style="display: none">
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="NumberType_TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox>
                    px</td>
            </tr>
            <tr class="tdbg">
                <td align="right">
            ...
            <tr class="tdbg">
                ...
                <td align="left">
                    <asp:TextBox ID="NumberType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
                </td>
            </tr>
            <tr class="tdbg">
                <td align="right">
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                <asp:Button ID="Button1" runat="server" Text=" 添加字段 " CssClass="button" OnClientClick="return isok()" OnClick="Button1_Click" />
                &nbsp;&nbsp;
                <input id="Button2" type="button" value=" 返回字段列表 " class="button" onclick="javascript:window.location.href='ModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>'" />
