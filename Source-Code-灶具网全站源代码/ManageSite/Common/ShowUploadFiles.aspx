<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Common.ShowUploadFiles, App_Web_p2xpnbfk" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="column">
        ...
        <table width="100%">
            <tr>
                ...
                <td align="right">
                    <a href='ShowUploadFiles.aspx?NodeID=<%=Request.QueryString["NodeID"]%>&Dir=<%=Server.UrlEncode(m_ParentDir) %>'>
                        返回上一级</a></td>
            </tr>
        </table>
