<%@ page language="C#" autoeventwireup="true" inherits="manage_User_ModifySysUserField, App_Web_0yhjvz4c" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
		...
		当前位置：功能导航 >> <span>后台管理</span>&gt;&gt;<span><a href="UserManage.aspx"> 用户管理</a></span> &gt;&gt;<span> <a href="">会员模型</a></span>
     ...
     <tr class="tdbg">
        ...
        <tbody id="DivListBoxType" style="display:none" runat="server">
            <tr class="tdbg">
                ...
                <td><input id="Button4" type="button" value="从数据字典中选择选项" class="btn" onclick="SelectDictionary('ListBoxType_Content')" /><input 
                        id="Button6" type="button" value="添加数据字段" onclick='SubPage("ListBoxType_Content")' /><br />
       ...
       <!--  文件类型    -->
        ...
        <tr class="tdbg">
            ...
            <td height="50">
                <asp:Button ID="Button1" runat="server" Text=" 修改字段 "  OnClientClick="return isok()" OnClick="Button1_Click" />
                &nbsp;&nbsp;
                <input id="Button2" type="button" value=" 返回字段列表 "  onclick="javascript:window.location.href='SystemUserModel.aspx'" />
