<%@ page language="C#" autoeventwireup="true" inherits="WebShop_UserOrderlist, App_Web_vwwbvku3" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>确认订单</title>
...
<body>
    ...
    <div id="main" class="rg_inout">
        ...
        <ul>
            ...
            <li>
                <asp:TextBox ID="Receiver" runat="server" CssClass="input_out"></asp:TextBox>
        ...
        <ul>
            ...
            <li>
                <asp:DropDownList ID="dddizhi" runat="server" OnSelectedIndexChanged="dddizhi_SelectedIndexChanged" AutoPostBack="True">
                </asp:DropDownList>
                <br />
                <asp:TextBox ID="Jiedao" runat="server" Width="409px" CssClass="input_out"></asp:TextBox>
                <asp:CheckBox ID="cbAdd" runat="server" />加入我的地址薄</li>
        ...
        <div class="cleardiv" style="margin-top: 30px">
        </div>
        <ul>
            <li style="width: 150px; text-align: right;"><b><span style="color:#FF0000">*</span> 收货人邮箱：</b></li>
            <li>
                <asp:TextBox ID="Email" runat="server"></asp:TextBox></li><asp:RequiredFieldValidator
                    ID="RequiredFieldValidator3" runat="server" ControlToValidate="Email" ErrorMessage="收货人邮箱不能为空!"
                    SetFocusOnError="True"></asp:RequiredFieldValidator></ul>
        <div class="cleardiv"></div>
        <ul style="margin-bottom: 20px">
            <li style="width: 150px; text-align: right;"><b>发票信息：</b></li>
            <li>
                <asp:TextBox ID="Invoice" runat="server" Height="46px" Width="331px" Rows="10" CssClass="input_out"></asp:TextBox>
        ...
        <ul>
            <li style="width: 150px; text-align: right;"><b><span style="color:#FF0000">*</span> 联系电话：</b></li>
            <li>
                <asp:TextBox ID="Phone" runat="server" CssClass="input_out"></asp:TextBox>格式:区号-号码
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="Phone"
                    ErrorMessage="联系电话格式不正确!" SetFocusOnError="True" ValidationExpression="(\(\d{3}\)|\d{3}-)?\d{8}|(\(\d{4}\)|\d{4}-)?\d{8}|(\(\d{4}\)|\d{4}-)?\d{8}|(\(\d{4}\)|\d{4}-)?\d{7}|(\(\d{4}\)|\d{4}-)?\d{7}"
        ...
        <ul>
            ...
            <li>
                <asp:TextBox ID="ZipCode" runat="server" CssClass="input_out"></asp:TextBox>
        ...
        <ul>
            ...
            <li>
                <asp:TextBox ID="Mobile" runat="server" CssClass="input_out"></asp:TextBox>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="Mobile"
                    ErrorMessage="手机号码格式不正确!" ValidationExpression="^(\d{2}|\d{3})?[\-]?(\d{11})$"
                    SetFocusOnError="True"></asp:RegularExpressionValidator></li></ul>
        <ul>
        ...
        <ul>
            ...
            <li>
                <asp:DropDownList ID="Delivery" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Delivery_SelectedIndexChanged1">
