<%@ page language="C#" autoeventwireup="true" inherits="User_Zone_Model_siteinfobase, App_Web_150n1jyo" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title></title>
<style type="text/css">
TD, P, LI, SELECT, INPUT
{
    font-size: 12px;
    font-family: "宋体";
}
...
<body>
    <br />
    <form name="form1" method="post" runat="server" action="siteinfobase.aspx" id="form1">
        ...
        <tr>
            <td align="center" valign="top" bgcolor="e5e5e5">
                <table width="980" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="10" background="/User/develop/images/RegSite/peizhi_07.png">
                        </td>
                        <td width="960" valign="top">
                            <table width="960" border="0" cellspacing="0" cellpadding="0">
                                <tr><td height="18" background="/User/develop/images/RegSite/peizhi_08.png"></td></tr>
                            </table>
                            <table width="960" border="0" cellspacing="0" cellpadding="0">
                                <tr><td height="37" bgcolor="#FFFFFF">&nbsp;</td></tr>
                            </table>
                            <table width="960" border="0" cellspacing="0" cellpadding="0">
                                <tr id="proc">
                                    <td width="234"><img src="/User/develop/images/RegSite/peizhi_09.png" width="234" height="42" /></td>
                                                                    ...
                                                                    <tr>
                                                                        <td height="10" colspan="3" align="left">
                                                                            <table width="600" border="0" cellspacing="0" cellpadding="0">
                                                                                ...
                                                                                <tr><td width="160"></td><td width="440" valign="baseline"></td></tr>
                                                                                <tr>
                                                                            ...
                                                                            <table width="600" border="0" cellspacing="0" cellpadding="0">
                                                                                ...
                                                                                <tr>
                                                                                    <td width="100" align="right">
                                                                                        <span class="STYLE15"><span class="STYLE13">*</span>网站名称：</span>
                                                                                    </td>
                                                                            ...
                                                                            <div id="mynetpanel">
                                                                                <table width="600" border="0" cellspacing="0" cellpadding="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <textarea name="Copyright" rows="2" cols="20" style="height: 70px; width: 319px;"
                        ...
                        <td width="10" background="/User/develop/images/RegSite/peizhi_07_0.png">
                        </td>
                    </tr>
                </table>
            </td>
