<%@ page language="C#" autoeventwireup="true" inherits="User_Message_MessageGarbagebox, App_Web_wtzgd1id" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>垃圾箱</title>
...
您现在的位置：<span id="YourPosition"><span><a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt;<a title="会员中心" href="/User/Default.aspx" target="信息管理">会员中心</a> &gt;&gt; <a title="短消息管理" href="/User/Message/MessageGarbagebox.aspx">垃圾箱</a>
</div>
