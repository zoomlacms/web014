<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_Default, App_Web_ut32hk44" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<%@ Register src="~/User/Info/WebUserControlTop.ascx" tagname="WebUserControlTop" tagprefix="uc1" %>
<html>
<head runat="server">
<title>我的返利</title>
      ...
      <table width="100%">
        <tr>
          ...
          <td style="width:100px"><br />
            <b>
            <asp:Label ID="lblAuditPro" runat="server" ForeColor="Red"></asp:Label>
            </b></td>
          <td align="left"><br />
            <a href="Profile.aspx">查看待返利详情>></a><br /></td>
        </tr>
        <tr>
          <td align="left"><br />
            返利帐户余额:</td>
          <td style="width:100px"><br />
            <b>
            <asp:Label ID="lblFmoney" runat="server" ForeColor="Red"></asp:Label>
            </b></td>
          <td align="left"><br />
            <a href="Profile.aspx?state=1">查看返利详情>></a><br /></td>
        </tr>
        <tr>
          <td align="left"><br />
            申请中的返利:</td>
          <td><br />
            <b>
            <asp:Label ID="lblSMoney" runat="server"></asp:Label>
            </b></td>
          <td align="left"><br />
            为了账户安全,第一次申请兑现300元以上返利者,必须使用注册邮箱发送返利网用户名和收款人真实姓名 <br />
            到：web@hx008.cn，以便确认!</td>
        </tr>
        <tr>
          <td align="left"><br />
            已兑现的返利:</td>
          <td><br />
            <b>
            <asp:Label ID="lblOPro" runat="server"></asp:Label>
            </b></td>
          <td align="left"><br />
            <a href="ToCashRebates.aspx">详细记录>></a></td>
        </tr>
        <tr>
          <td align="left"><br />
            红包函数量:</td>
          ...
          <td align="left"><br />
            <a href="../PromotUnion/Redindulgence.aspx" target="_blank">什么是红包函? </a></td>
        </tr>
        <tr>
          <td align="left"><br />
            红包申请：</td>
          ...
          <td align="left"><br />
            <a href="RedEnvelopeRecard.aspx" target="_blank">查看红包申请记录>> </a></td>
        </tr>
        <tr>
          <td><br /></td>
        </tr>
                  ...
                  <td ><table cellspacing="1" cellpadding="0" width="100%" border="0">
                      <tr>
                        <td ><table cellspacing="0" cellpadding="6" width="100%" border="0">
                            <tr>
                              <td width="33%"  height="30" align="left" style="border-bottom:dotted #ccc 0px; font-weight:bold;"><asp:DropDownList ID="ddlAmount" runat="server" > </asp:DropDownList>
                                &nbsp;
                            ...
                            <tr>
                              <td height="30" colspan="2" align="left" ><input type="button" id="Button1" runat="server" disabled="disabled"  onclick="javascript:window.open('pass.aspx','new','width=350px,height=200px,top=300, left=300')" value="兑现" style=" height:25px; width:120px; text-align:center;" /></td>
                            </tr>
                            <tr >
                            ...
                            <tr>
                              <td colspan="2" ><b>注意事项：</b><br>
                                <div id="divHonor" runat="server"></div></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table></td>
                  ...
                  <td ><table cellspacing="1" cellpadding="0" width="100%" border="0">
                      <tr>
                        <td ><table cellspacing="0" cellpadding="6" width="100%" border="0">
                            ...
                            <tr>
                              <td colspan="3" height="80" align="center" style="border-top:1px dotted #ccc;border-bottom:1px dotted #ccc;"><asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                  <ContentTemplate>
                                    <table  width="100%">
                                      <tr>
                                      ...
                                      <div id="Gife" >
                                        <table width="100%">
                                          <tr>
                                            ...
                                            <td align="left"><asp:DropDownList ID="ddGife" runat="server"  AutoPostBack="true" onselectedindexchanged="ddGife_SelectedIndexChanged"></asp:DropDownList>
                                              (即礼品卡所需返利金额)</td>
                                          </tr>
                                          <tr>
                                            <td align="right">礼品卡:</td>
                                            <td align="left"><asp:DropDownList ID="ddGifeCard" runat="server"></asp:DropDownList>
                                              (价格小于等于返利金额的礼品卡)</td>
                                          </tr>
                                        </table>
                                      </div>
                            ...
                            <tr >
                              <td colspan="3" ><b>注意：</b><br>
                                <div id="divSmell" runat="server"></div></td>
                          </table></td>
                      </tr>
                    </table></td>
                </tr>
                ...
                <tr>
                  <td ><table cellspacing="1" cellpadding="0" width="100%" border="0">
                      <tr>
                        <td ><table cellspacing="0" cellpadding="6" width="100%" border="0">
                            <tr>
                              <td width="100%" height="60" align="center" style="border-bottom:dotted #fff 1px; font-weight:bold;"><asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                  <ContentTemplate> 兑现申请时间:
                            ...
                            <tr>
                              <td ><b>奖励规则：</b><br />
                                <div id="divGu" runat="server"></div></td>
                            </tr>
                            <tr>
                              <td height="5px"></td>
                            </tr>
                            <tr>
                              <td ><b>注意事项：</b><br />
                                <div id="divImp" runat="server"></div></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table></td>
