<%@ page language="C#" autoeventwireup="true" inherits="_Default, App_Web_b0eoz3ro" enableEventValidation="false" viewStateEncryptionMode="Never" %>
						...
						<asp:Panel ID="Panel1" runat="server" Height="50px" Width="100%">
							<table width="100%" cellpadding="0" cellspacing="0" border="0">
								<tr>
									...
									<td align="center">
										<asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/User/UserZone/Parking/CarImage/reme.gif"
											OnClick="ImageButton2_Click" />
									</td>
									<td align="right">
										<asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/User/UserZone/Parking/CarImage/next.gif"
						...
						<asp:Repeater ID="Repeater1" runat="server">
							...
							<ItemTemplate>
								<table width="100%">
									<tr>
										<td>
											我<%#DataBinder.Eval(Container.DataItem, "P_content")%>
										</td>
		...
		<td valign="top">
			<asp:Panel ID="Panel2" runat="server" Width="100%">
				<table>
					...
					<tr>
						<td>
							<a href="javascript:showPopWin('我的车辆','ShowMyCar.aspx?Math.random()',500,300, retCar,true)">
								我的车辆</a>
						</td>
					</tr>
					<tr>
						<td>
							<a href="javascript:showPopWin('我的好友','MyFriendList.aspx?Math.random()',400,200, retFriend,true)">
								停放到好友的车位</a>
						</td>
					</tr>
				</table>
