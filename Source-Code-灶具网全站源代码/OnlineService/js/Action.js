...
function e_PostContentf() {
    var content = document.getElementById("ZoomlaEditorIframe").document.frames['ZoomlaEditorForm'].document.getElementsByTagName('BODY')[0].innerHTML;
    doPrompt("start");
    ...
    ajax.post(
		...
		function (obj) {
		    if (obj.responseText != "") {
		        ...
		        document.getElementById("ZoomlaEditorIframe").document.frames['ZoomlaEditorForm'].document.getElementsByTagName('BODY')[0].innerHTML = "";
