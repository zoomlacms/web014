<%@ page language="C#" autoeventwireup="true" inherits="WebShop_UserCart, App_Web_x0bhtz4p" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>加入购物车</title>
...
<div id="main" class="rg_inout">
    ...
    <ul>
        ...
        <li><asp:Button ID="Button1" CssClass="i_bottom" runat="server" Text="去结算" OnClick="Button1_Click" /></li>
