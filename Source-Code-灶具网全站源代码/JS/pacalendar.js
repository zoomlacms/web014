...
var jsstaly = "<style>body {font-size:12px;font-family:'Lucida Grande','Lucida Sans Unicode','宋体',arial,verdana,sans-serif;}"
                + "select{border:1px solid #369;font-size:12px;margin:0 5px;}"
                + "fieldset {margin:5px;padding:0 14px 14px 14px; border:1px solid #D4D4D4;background-color:#F9F9F9;}"
                + "legend {font-weight:bold;}"
                + ".center { text-align:center;}"
                + ".red {color:#F00;}"
                + "#calendar_container {width:180px; border:1px solid #06C;}"
                + "#calendar {border-collapse:collapse;background-color:#FFF;width:180px;height:140px;margin:0px auto;cursor:default;}"
                ...
                + "#calendar caption {background-color:#06C;}"
                ...
                + "#calendar .keydate {color:#06F;}</style>";
document.write(jsstaly);
//基本函数库
