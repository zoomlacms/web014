...
function showkeyboard(x, y) {
    if (closestr == 0) {
        document.getElementById("softkeyboard").style.top = y;
        document.getElementById("softkeyboard").style.left = x;
