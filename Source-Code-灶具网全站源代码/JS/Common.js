...
function DealwithUploadPic(path, id) {
    ...
    //parent.document.getElementById(id).value = path;
    //alert(parent.document.getElementsByName(id).length);
    //alert(parent.document.getElementsByName(id).item(0).value);
    //parent.document.getElementsByName(id).item(0).value = path;
    //parent.document.getElementsByName(id).item(0).value = path;
}
